...
function Register() {
  ...
  const verifyEmail = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}api/auth/sendmail`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const verifyOTP = async (e) => {
    ...
    try {
      ...
      const otpResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}api/auth/verify`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
